...
namespace Cervantes.DAL.Migrations
{
    ...
    [Migration("20250723100359_IncreaseSourceIdentifierLength")]
    partial class IncreaseSourceIdentifierLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.Audit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.Checklist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ChecklistCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ChecklistExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ChecklistExecutions");
                });

            modelBuilder.Entity("Cervantes.CORE.Entities.ChecklistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ChecklistTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ClientCustomFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ClientCustomFieldId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClientCustomFieldId");

                    b.HasIndex("UserId");

                    b.HasIndex("ClientId", "ClientCustomFieldId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ProjectCustomFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ProjectCustomFieldId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProjectId", "ProjectCustomFieldId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.VulnCustomField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VulnCustomFields");
                });

            modelBuilder.Entity("Cervantes.CORE.Entities.VulnCustomFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("VulnCustomFieldId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VulnCustomFieldId");

                    b.HasIndex("VulnId", "VulnCustomFieldId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.Checklist", b =>
                {
                    b.HasOne("Cervantes.CORE.Entities.ChecklistTemplate", "ChecklistTemplate")
                        .WithMany("Checklists")
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ChecklistExecution", b =>
                {
                    b.HasOne("Cervantes.CORE.Entities.Checklist", "Checklist")
                        .WithMany("Executions")
                        .HasForeignKey("ChecklistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cervantes.CORE.Entities.ChecklistItem", "ChecklistItem")
                        .WithMany("Executions")
                        .HasForeignKey("ChecklistItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Cervantes.CORE.Entities.ApplicationUser", "TestedByUser")
                        .WithMany()
                        .HasForeignKey("TestedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Cervantes.CORE.Entities.Vuln", "Vulnerability")
                        .WithMany()
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ChecklistItem", b =>
                {
                    b.HasOne("Cervantes.CORE.Entities.ChecklistCategory", "ChecklistCategory")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ChecklistTemplate", b =>
                {
                    b.HasOne("Cervantes.CORE.Entities.Organization", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ClientCustomFieldValue", b =>
                {
                    b.HasOne("Cervantes.CORE.Entities.ClientCustomField", "ClientCustomField")
                        .WithMany("Values")
                        .HasForeignKey("ClientCustomFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ClientCustomField");
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.ProjectCustomFieldValue", b =>
                {
                    b.HasOne("Cervantes.CORE.Entities.ProjectCustomField", "ProjectCustomField")
                        .WithMany("Values")
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.VulnCustomFieldValue", b =>
                {
                    ...
                    b.HasOne("Cervantes.CORE.Entities.VulnCustomField", "VulnCustomField")
                        .WithMany("Values")
                        .HasForeignKey("VulnCustomFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
