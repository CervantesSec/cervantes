...
public class PDFManager
{
    ...
    {
        var model = data;
        var templatePath = Path.Combine(Path.GetDirectoryName(Assembly.GetEntryAssembly().Location),
            $"View/Report/Template.cshtml");
        var template = await _razorEngine.CompileRenderAsync(templatePath, model);
