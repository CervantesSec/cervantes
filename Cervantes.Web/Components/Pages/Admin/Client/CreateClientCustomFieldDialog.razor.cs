...
public partial class CreateClientCustomFieldDialog : ComponentBase
{
    ...
    MudForm form;
    ClientCustomFieldCreateValidator validator = new ClientCustomFieldCreateValidator();
    
    private ClientCustomFieldCreateViewModel model = new ClientCustomFieldCreateViewModel();
    ...
    private async System.Threading.Tasks.Task Submit()
    {
        ...
        if (form.IsValid)
        {
            ...
            try
            {
                var result = await ClientCustomFieldController.Post(model);
...
public class ClientCustomFieldCreateValidator : AbstractValidator<ClientCustomFieldCreateViewModel>
{
    public ClientCustomFieldCreateValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
    ...
    {
        var result = await ValidateAsync(ValidationContext<ClientCustomFieldCreateViewModel>.CreateWithOptions((ClientCustomFieldCreateViewModel)model, x => x.IncludeProperties(propertyName)));
        if (result.IsValid)
