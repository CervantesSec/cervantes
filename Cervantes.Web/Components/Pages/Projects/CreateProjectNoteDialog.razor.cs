...
public partial class CreateProjectNoteDialog: ComponentBase
{
   private Dictionary<string, object> editorConf = new Dictionary<string, object>{
    ...
    private ProjectCreateNoteViewModel model = new ProjectCreateNoteViewModel();
    ...
    public class NoteModelFluentValidator : AbstractValidator<ProjectCreateNoteViewModel>
    {
        ...
        {
            var result = await ValidateAsync(ValidationContext<ProjectCreateNoteViewModel>.CreateWithOptions((ProjectCreateNoteViewModel)model, x => x.IncludeProperties(propertyName)));
            if (result.IsValid)
    ...
    private async System.Threading.Tasks.Task Submit()
    {
        ...
        if (form.IsValid)
        {
            ...
            var response = await ProjectController.AddNote(model);
