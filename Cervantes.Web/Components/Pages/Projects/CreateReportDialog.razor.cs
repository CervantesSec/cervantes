...
public partial class CreateReportDialog: ComponentBase
{
 ...
 [Parameter] public Guid project { get; set; }
    ...
    public class ReportModelFluentValidator : AbstractValidator<ReportCreateViewModel>
    {
        ...
        {
            var result = await ValidateAsync(ValidationContext<ReportCreateViewModel>.CreateWithOptions((ReportCreateViewModel)model, x => x.IncludeProperties(propertyName)));
            if (result.IsValid)
