...
[Inject] private IJIraService JiraService { get; set; }
    ...
    async Task DeleteVulnDialog(CORE.Entities.Vuln vuln,DialogOptions options)
    {
        if (inProject || vuln.Project == null || vuln.ProjectId == Guid.Empty)
        {
            ...
            var dialog =  Dialog.Show<DeleteVulnDialog>("Edit", parameters,options);
    ...
    async Task RowClickedTargets(DataGridRowClickEventArgs<CORE.Entities.VulnTargets> args)
    {
        if (inProject)
        {
            ...
            var dialog =  Dialog.Show<DeleteVulnTarget>(@localizer["deleteTarget"], parameters, medium);
            var result = await dialog.Result;
    ...
    async Task OpenDialogAddTarget(DialogOptions options)
    {
        ...
        var dialog =  Dialog.Show<AddVulnTarget>(@localizer["addTarget"], parameters,options);
        var result = await dialog.Result;
    ...
    async Task RowClickedNotes(DataGridRowClickEventArgs<CORE.Entities.VulnNote> args)
    {
        ...
        var dialog =  Dialog.Show<VulnNoteDialog>(@localizer["deleteNote"], parameters, maxWidth);
        var result = await dialog.Result;
    ...
    async Task OpenDialogAddNote(DialogOptions options)
    {
        ...
        var dialog =  Dialog.Show<AddVulnNote>(@localizer["addNoteBtn"], parameters,options);
        var result = await dialog.Result;
    ...
    async Task RowClickedAttachments(DataGridRowClickEventArgs<CORE.Entities.VulnAttachment> args)
    {
        ...
        var dialog =  Dialog.Show<VulnAttachmentDialog>(@localizer["addAttachment"], parameters, maxWidth);
        var result = await dialog.Result;
    ...
    async Task OpenDialogAddAttachment(DialogOptions options)
    {
        ...
        var dialog =  Dialog.Show<AddVulnAttachment>(@localizer["deleteAttachment"], parameters,options);
        var result = await dialog.Result;
    ...
    private async Task BtnActionsTargets(int id)
    {
        switch (id)
        {
            case 0:
                ...
                var dialog =  Dialog.Show<DeleteVulnTargetBulkDialog>("Edit", parameters,maxWidth);
                var result = await dialog.Result;
    ...
    private async Task BtnActionsNotes(int id)
    {
        switch (id)
        {
            case 0:
                ...
                var dialog =  Dialog.Show<DeleteVulnNoteBulkDialog>("Edit", parameters,maxWidth);
                var result = await dialog.Result;
    ...
    private async Task BtnActionsAttachments(int id)
    {
        switch (id)
        {
            case 0:
                ...
                var dialog =  Dialog.Show<DeleteVulnAttachmentBulkDialog>("Edit", parameters,maxWidth);
                var result = await dialog.Result;
