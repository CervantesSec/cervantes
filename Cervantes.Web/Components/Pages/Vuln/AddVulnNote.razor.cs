...
public partial class AddVulnNote: ComponentBase
{
    ...
    VulnNoteViewModel note = new VulnNoteViewModel();
    ...
    public class NoteModelFluentValidator : AbstractValidator<VulnNoteViewModel>
    {
        ...
        {
            var result = await ValidateAsync(ValidationContext<VulnNoteViewModel>.CreateWithOptions((VulnNoteViewModel)model, x => x.IncludeProperties(propertyName)));
            if (result.IsValid)
