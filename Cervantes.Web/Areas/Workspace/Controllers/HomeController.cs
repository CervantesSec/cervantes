...
public class HomeController : Controller
{
    ...
    public HomeController(IProjectManager projectManager, IClientManager clientManager, IVulnManager vulnManager,
        ITaskManager taskManager, IDocumentManager documentManager,
        IProjectUserManager projectUserManager, ITargetManager targetManager, IProjectNoteManager projectNoteManager,
        IProjectAttachmentManager projectAttachmentManager,
    ...
    public ActionResult Index(int project)
    {
        ...
        {
            _logger.LogError(e, "An error ocurred loading Home Workspace Dashboard. Project: {0} User: {1}", project,
