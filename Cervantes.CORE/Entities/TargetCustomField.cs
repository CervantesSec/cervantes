...
/// <summary>
/// Defines a custom field schema that can be used for targets
/// </summary>
public class TargetCustomField
{
    ...
    /// <summary>
    /// Whether this field is required when creating/editing targets
    /// </summary>
    public bool IsRequired { get; set; }

    /// <summary>
    /// Whether the value of this field must be unique across all targets
    /// </summary>
    ...
    /// <summary>
    /// Whether this field should be visible as a column in the target table
    /// </summary>
    ...
    /// <summary>
    /// Collection of values for this custom field across all targets
    /// </summary>
    [JsonIgnore]
    public virtual ICollection<TargetCustomFieldValue> Values { get; set; } = new List<TargetCustomFieldValue>();
}