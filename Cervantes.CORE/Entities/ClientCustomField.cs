...
/// <summary>
/// Defines a custom field schema that can be used for clients
/// </summary>
public class ClientCustomField
{
    ...
    /// <summary>
    /// Whether this field is required when creating/editing clients
    /// </summary>
    public bool IsRequired { get; set; }

    /// <summary>
    /// Whether the value of this field must be unique across all clients
    /// </summary>
    ...
    /// <summary>
    /// Whether this field should be visible as a column in the client table
    /// </summary>
    ...
    /// <summary>
    /// Collection of values for this custom field across all clients
    /// </summary>
    [JsonIgnore]
    public virtual ICollection<ClientCustomFieldValue> Values { get; set; } = new List<ClientCustomFieldValue>();
}