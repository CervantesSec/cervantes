...
/// <summary>
/// Stores the actual value of a custom field for a specific target
/// </summary>
public class TargetCustomFieldValue
{
    /// <summary>
    ...
    /// <summary>
    /// The target this value belongs to
    /// </summary>
    [ForeignKey("TargetId")]
    [JsonIgnore]
    ...
    /// <summary>
    /// ID of the target this value belongs to
    /// </summary>
    [Required]
    ...
    /// </summary>
    [ForeignKey("TargetCustomFieldId")]
    [JsonIgnore]
    public virtual TargetCustomField TargetCustomField { get; set; }
