...
/// <summary>
/// Defines a custom field schema that can be used for vulnerabilities
/// </summary>
public class VulnCustomField
{
    /// <summary>
    ...
    /// <summary>
    /// Whether this field is required when creating/editing vulnerabilities
    /// </summary>
    public bool IsRequired { get; set; }

    /// <summary>
    /// Whether the value of this field must be unique across all vulnerabilities
    /// </summary>
    ...
    /// <summary>
    /// Whether this field should be visible as a column in the vulnerability table
    /// </summary>
    ...
    /// <summary>
    /// Collection of values for this custom field across all vulnerabilities
    /// </summary>
    [JsonIgnore]
    public virtual ICollection<VulnCustomFieldValue> Values { get; set; } = new List<VulnCustomFieldValue>();
}